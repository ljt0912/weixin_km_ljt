...
import edu.gdkm.weixin.service.MessageService;
import edu.gdkm.weixin.service.MessageTypeRegister;
...
@RequestMapping("/kemao_3_t/weixin/reciver") // 访问哪个路径的时候，被此控制器处理
